    ...
    <div class="orderDetail">
        <section class="vipBox van-hairline--top">
            <template v-if="orderState>1">
                ...
                <div class="downLoad">
                      <div class="notice">
                            <p >活动期间，再附赠您一张电子卡并自动激活！</p>
                            <p >实体麒麟卡稍后寄出，分享给好友激活，可有机会获取红包哟！</p>
                      </div>
                      <button class="downloadBtn" @click="onUseCard">点击【刷新】，享受麒麟会员权益！</button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 定时获取订单状态
            initOrderStateTimer(){
               if(this.orderState == 1 || isNull(this.orderState)) {
