...
<script>
    ...
    export default {
        ...
        data(){
            return{
                hqzbActBg:require('@/assets/images/goodsActive/hqzbActBg.png'),
                hqzbTop:require('@/assets/images/goodsActive/hqzbTop.png'),
                hqzbBest:require('@/assets/images/goodsActive/hqzbBest.png'),
                itemActGroups:[],
                saleTopGoods:[],
                itemActGroupGoods:[],
                groupId:'',
        ...
        computed: {
            ...
            banner(){
                let bannerObj = {};
                bannerObj.img = this.hqzbActBg;
                bannerObj.height = '21.25rem';
                bannerObj.bgAll= '#B40C08';
                return bannerObj;
            },
    ...
    .goodsActBox{
        ...
        .topBanner{
            ...
            .saletabList{
                ...
                position:relative;
                top:-1.25rem /* 20/16 */;
                padding:.8125rem /* 13/16 */ .625rem /* 10/16 */;
                .saleItem{
                    ...
                    &.active{
                        background:linear-gradient(0deg,rgba(252,213,155,1),rgba(255,252,249,1));
                        color:#D01100;
                        font-size:.875rem /* 14/16 */;
                        font-weight: 500;
                    }
