<template>
    <div class="goodsActBox"  v-title :data-title="actName" ref='goodsActBox'>
        <topFixed 
            :isScroll="isScroll"
            :closeTips="closeTips" 
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                aclActBg:require('@/assets/images/goodsActive/vipActBg.png'),
                itemActGroups:[],
                saleTopGoods:[],
                itemActGroupGoods:[],
                groupId:'',
        ...
        computed: {
            ...
            banner(){
                let bannerObj = {};
                bannerObj.img = this.aclActBg;
                bannerObj.height = '18.5rem';
                return bannerObj;
            },
...
<style lang="scss" scoped>
    .goodsActBox{
        ...
        .actGroupGoods{
            width:100%;
            background:linear-gradient(-180deg,#56a467,#3e874e);
            ...
            .actGroupGoodsItem{
                ...
                .label{
                    ...
                    background:url('../../../assets/images/goodsActive/aclLabel.png') center no-repeat;
