...
<script>
    ...
    export default {
        ...
        data(){
            return{
                fgActBg:require('@/assets/images/goodsActive/fgActBg.png'),
                itemActGroups:[],
                saleTopGoods:[],
                itemActGroupGoods:[],
                groupId:'',
...
<style lang="scss" scoped>
    .goodsActBox{
        background:linear-gradient(190deg,rgba(163,236,229,1),rgba(121,212,198,1),rgba(121,212,198,1),rgba(164,235,229,1));
        .topBanner{
            width:100%;
            position:relative;
