<template>
	<div class="box" >
		...
		<section class="block selectedPrivileges">
			...
			<div class="selectedPrivilegesBody" @click="getCard">
				<div class="bodyLeft">
				...
				<div class="bodyRight">
					...
					<div class="rightCon">
						<img :src="selectedPrivileges3" alt="">
						<div class="bodyContent">
		...
		<section class="block globalBrand">
			...
			<!-- brand 产品列表 -->
			<div class="globalBrandBody">
				<div class="globalTab">
					<span class="tabItem" v-for="(tabItem,index) in globalTab" :key="index+2" :class="{'active':currentBrand == index}" @click="selectBrand(tabItem,index)">{{tabItem}}</span>
				</div>
		...
		<section class="block membershipPrivileges">
			...
			<div class="membershipPrivilegesBody">
		...
		<section class="block cooperation">
			...
			<div class="cooperationBody">
				<div class="cooperate">
					...
					<p>如果您提供优质的品牌权益</p>
					<p>请将合作需求以邮件的形式</p>
					<p>发送至邮箱jingguitar520@163.com</p>
					<p>期待与您的合作</p>
				</div>
				<div class="contact">
					<div class="headTitle">
...
export default {
	...
	data () {
		return {
			...
			globalTab:['BRISTION','ELLE','慕拉'],
			membershipPrivilegeTab:[
				{name:'热门推荐',englishName:'hotRecommend'},
			...
			selectedPrivileges1:require('@/assets/images/home/selectedPrivileges1.png'),
	...
	created() {
		...
		this.$nextTick(()=>{
			...
			this.selectBrand('BRISTION',0)
			this.selectPrivilege('hotRecommend',0)
		})
	...
	methods: {
		...
		selectBrand(type,index){
			...
			if(type == '慕拉'){
				this.globalBrandList = this.homeDatas.globalBrand.mula
				
			}else{
				this.globalBrandList = this.homeDatas.globalBrand[type]
			}
			this.$nextTick(()=>{
				this.globalBrandWidth()
			})
		},
...
<style lang="scss" scoped>
	.box{
		...
		.block{
			...
			margin-top:vw(15);
			border-radius:vw(10);
			background: linear-gradient(318deg, #f43939 0%, #ff9492 100%);
			font-weight: 400;
			&.selectedPrivileges{
				background: linear-gradient(90deg,rgba(118,70,154,1),rgba(57,35,80,1));
				.selectedPrivilegesBody{
					background:#fff;
					border-radius: vw(10) /* 10/16 */;
					padding:vw(10) /* 10/16 */;
					display:flex;
					height:vw(180)/* 180/16 */;
					.bodyContent{
						position:absolute;
						top:0;
						left:0;
						...
						text-align: center;
						padding-top:vw(20)/* 20/16 */;
						.title{
							font-size:vw(15) /* 15/16 */;
							color:#fff;
							font-weight: 400;
						}
						.subTitle{
			...
			ul{
				...
				li{
					...
					.tipsLabel{
						width:vw(35) /* 35/16 */;
						height:vw(14) /* 14/16 */;
						background:linear-gradient(-90deg,rgba(189,31,11,1),rgba(238,88,68,1));
						border-radius:vw(14)/* 14/16 */;
						font-size:vw(10) /* 10/16 */;
						font-weight: 300;
						color:#fff;
						position:absolute;
		...
		.agreement{
			padding:.9375rem /* 15/16 */ .625rem /* 10/16 */ 6.875rem /* 110/16 */;
			.company{
				color:#DFD3B8;
				text-align:center;
				font-weight: 400;
