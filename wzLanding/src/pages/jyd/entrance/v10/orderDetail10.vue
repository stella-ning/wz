    ...
    <div class="orderDetail">
        ...
        <section class="vipBox">
            <template v-if="orderState>1">
                ...
                <div class="downLoad">
                    <button class="downloadBtn" @click="onDownLoad">下载app并激活，享受所有省钱特权</button>
                    <div class="notice">
    ...
    export default {
        ...
        data(){
            return{
                ...
                orderTop:require('@/assets/images/order/orderTop.png'),
        ...
        .vipBox{
            ...
            .downLoad{
                ...
                .downloadBtn{
                    ...
                    line-height:vw(44);
                    margin:0 auto;
                    background:linear-gradient(0deg,rgba(236,201,125,1),rgba(253,231,183,1));;
                    box-shadow:vw(0) vw(4) vw(5) vw(0) rgba(236,202,126,0.7);
                    border-radius: vw(44);
                    font-size:vw(16);
                    color:#75460A;
                    border:none;
