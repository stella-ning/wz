	...
	<div class="box" >
		...
		<section class="partOne">
			...
			<div class="themeList discount" @click="getCard">
				<ul class="version2 flex justify-center">
					<li class="themeContent" v-for="(item,index) in homeDatas.discount2" :key="index">
						<div class="imgBox">
							<img :src="item.logo" alt="">
						</div>
						<p class="title">{{item.title}}</p>
...
export default {
	...
	data () {
		return {
			...
			membershipPrivilegeTab:[
				{name:'热门推荐',englishName:'hotRecommend2'},
				{name:'生活服务',englishName:'liveServer2'},
				{name:'美食饮品',englishName:'foodDrink2'},
				{name:'旅游出行',englishName:'travelTrip2'},
				{name:'影音娱乐',englishName:'entertainment2'},
			],
	...
	created() {
		...
		this.$nextTick(()=>{
			...
			this.selectPrivilege('hotRecommend2',0)
		})
