<template>
    <div class="addressForm">
        ...
        <div class="templateBox">
            <div class="con">
                <div class="title">名额仅剩：<div style="color:#EF2205;display:inline-block;" :class="{'isPlus':isPlus}">{{leftWidth}}</div></div>
                <div class="processe">
                    <div class="progress-bar active" :style="`width: ${progressWidth};`" ref="progressBar">
                        <div class="progress-value">{{progressWidth}}</div>
                    </div>
                </div>
                <div class="imgBox">
        ...
        <footer>
            <div class="footerBtn flex align-center footerFixed" >
                <div class="left van-hairline--top">
                    ...
                    <div class="tips">名额仅剩：{{leftWidth}} </div>
                </div>
                <div class="right">
                    <van-button class="submitBtn"  @click="onSubmit"  :loading='btnLoading'>提交申请</van-button>
                </div>
                <div  class="label" :style="`background:url(${specialBg}) 0% 25% no-repeat;background-size:contain`">
    ...
    export default {
        ...
        data(){
            return{
                ...
                userIcon:require('@/assets/images/v12/userIcon.png'),
                phoneIcon:require('@/assets/images/v12/phoneIcon.png'),
                areaIcon:require('@/assets/images/v12/areaIcon.png'),
                detailIcon:require('@/assets/images/v12/detailIcon.png'),
                limitActive:require('@/assets/images/v12/limitActive.png'),
                tips:require('@/assets/images/order/tips.png'),
                specialBg:require('@/assets/images/buy/specialBg.png'),
                addressBg:require('@/assets/images/v12/addressBg.png'),
                buyBtnBg:require('@/assets/images/v12/buyBtnBg.png'),
                btnLoading:false,
                isPopstate:false,
                versionCode:'',
                time:'',
    ...
    .addressForm{
        ...
        .processe{
            ...
            .progress-value{
                ...
                color: #4E2302;
                border-radius: 4px;
                background: linear-gradient(-90deg,rgba(255,204,128,1),rgba(253,231,183,1));
                position: absolute;
                top: -30px;
                right: -10px;
            }
