                    ...
                    <van-radio-group v-model="postage">
                        <van-cell-group >
                            <van-cell van-hairline--bottom clickable @click="postage = '1'">
                                ...
                                <van-radio slot="right-icon" name="1" checked-color="#ECC97E"/>
                            </van-cell>
                        </van-cell-group>
                    ...
                    <van-radio-group v-model="payWay">
                        <van-cell-group>
                            <van-cell van-hairline--bottom v-if="(app_pay_type == 'alipay' || app_pay_type == 'all') && !isWeixinClient"  clickable @click="payWay = 'alipay'">
                                ...
                                <van-radio slot="right-icon" name="alipay" checked-color="#ECC97E"/>
                            </van-cell>
                            <div class="line van-hairline--bottom"></div>
                            <van-cell  v-if="(app_pay_type == 'weChat' || app_pay_type == 'all') && !isAlipayClient"  clickable @click="payWay = 'weChat'">
                                ...
                                <van-radio slot="right-icon" name="weChat" checked-color="#ECC97E" />
                            </van-cell>
                        </van-cell-group>
                    </van-radio-group>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            wxOfficialAccounts() {
                ...
                URL = encodeURIComponent(`${urlPrefix}#/card/buyCardNew?isSimple=${this.isSimple}&time=${new Date().getTime()}`)
                // 为了方便第三方的js统计。需要把他们的参数都拼接进来
                for (const key in this.$route.query) {
                        const element = this.$route.query[key];
                    if(key != 'isSimple') {
